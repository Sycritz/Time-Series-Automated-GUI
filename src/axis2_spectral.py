...
def compute_periodogram(
    series: pd.Series, taper: str | None, taper_pct: float
...
def smooth_spectrum(
    series: pd.Series, window: str, M: int
...
def compute_parametric_spectrum(
    ar_coeffs: list, ma_coeffs: list, sigma2: float, n_points: int
) -> tuple[np.ndarray, np.ndarray]:
    """
