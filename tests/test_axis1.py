...
from axis1_preprocessing import (apply_box_cox, apply_differencing,
                                 box_cox_auto, box_cox_inverse,
                                 box_cox_profile_loglik, box_cox_transform,
                                 impute_series, load_csv, rolling_mean,
                                 rolling_std, run_adf_test,
...
def test_run_adf_test():
    ...
    assert res_ns["verdict"] == (
        "Stationary" if expected_p_ns < 0.05 else "Non-Stationary"
    )
